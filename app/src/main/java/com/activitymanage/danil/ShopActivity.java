	...
	private void initialize(Bundle _savedInstanceState) {
		...
		clear.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (isfav) {
					dbl.setTitle("Celar");
					dbl.setMessage("Вы хотите удалить все?");
					...
					dbl.setTitle("Очистить");
					dbl.setMessage("Вы хотите очистить?");
					dbl.setPositiveButton("Да", new DialogInterface.OnClickListener() {
						@Override
						public void onClick(DialogInterface _dialog, int _which) {
							ori.clear();
		...
		ulist.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> _param1, View _param2, int _param3, long _param4) {
				...
				dbl.setMessage("Вы хотите удалить?");
				dbl.setPositiveButton("Да", new DialogInterface.OnClickListener() {
					@Override
					public void onClick(DialogInterface _dialog, int _which) {
		...
		flist.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> _param1, View _param2, int _param3, long _param4) {
				final int _position = _param3;
				dbl.setTitle("Добавить в список?");
				dbl.setMessage("Хотите добавить?");
				dbl.setPositiveButton("Да", new DialogInterface.OnClickListener() {
					@Override
					public void onClick(DialogInterface _dialog, int _which) {
						tmp.clear();
		...
		flist.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> _param1, View _param2, int _param3, long _param4) {
				...
				vib.vibrate((long)(100));
				dbl.setTitle("Удалить");
				dbl.setMessage("Вы точно хотите удалить");
				dbl.setPositiveButton("Да", new DialogInterface.OnClickListener() {
					@Override
					public void onClick(DialogInterface _dialog, int _which) {
