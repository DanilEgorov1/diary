...
public class NoteActivity extends AppCompatActivity {
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		listview1.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> _param1, View _param2, int _param3, long _param4) {
				...
				tpl.setNegativeButton("Удалить", new DialogInterface.OnClickListener() {
					@Override
					public void onClick(DialogInterface _dialog, int _which) {
						dbl.setTitle("Удалить");
						dbl.setMessage("Вы точно хотите это удалить?\nэто невозможно будет вернуть");
				...
				tpl.setNeutralButton("Отмена", new DialogInterface.OnClickListener() {
					@Override
					public void onClick(DialogInterface _dialog, int _which) {
	...
	private void initializeLogic() {
		...
		if (data.getString("tour", "").equals("true")) {
			...
			sgl.setTitle("");
			sgl.setMessage("");
			sgl.setPositiveButton("", new DialogInterface.OnClickListener() {
				@Override
				public void onClick(DialogInterface _dialog, int _which) {
